...
func newQuestion(db *gorm.DB, opts ...gen.DOOption) question {
	...
	_question.questionDo.UseModel(&sqlentity.Question{})
	...
	_question.Hints_ = field.NewString(tableName, "hints")
...
func (q *question) updateTableName(table string) *question {
	...
	q.Hints_ = field.NewString(table, "hints")
...
type IQuestionDo interface {
	...
	Create(values ...*sqlentity.Question) error
	CreateInBatches(values []*sqlentity.Question, batchSize int) error
	Save(values ...*sqlentity.Question) error
	First() (*sqlentity.Question, error)
	Take() (*sqlentity.Question, error)
	Last() (*sqlentity.Question, error)
	Find() ([]*sqlentity.Question, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*sqlentity.Question, err error)
	FindInBatches(result *[]*sqlentity.Question, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*sqlentity.Question) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*sqlentity.Question, error)
	FirstOrCreate() (*sqlentity.Question, error)
	FindByPage(offset int, limit int) (result []*sqlentity.Question, count int64, err error)
...
func (q questionDo) Create(values ...*sqlentity.Question) error {
	if len(values) == 0 {
		return nil
	}
...
func (q questionDo) CreateInBatches(values []*sqlentity.Question, batchSize int) error {
	return q.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (q questionDo) Save(values ...*sqlentity.Question) error {
	if len(values) == 0 {
		return nil
	}
...
func (q questionDo) First() (*sqlentity.Question, error) {
	if result, err := q.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*sqlentity.Question), nil
	}
}

func (q questionDo) Take() (*sqlentity.Question, error) {
...
func (q questionDo) Last() (*sqlentity.Question, error) {
...
func (q questionDo) Find() ([]*sqlentity.Question, error) {
	result, err := q.DO.Find()
	return result.([]*sqlentity.Question), err
}

func (q questionDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*sqlentity.Question, err error) {
	buf := make([]*sqlentity.Question, 0, batchSize)
...
func (q questionDo) FindInBatches(result *[]*sqlentity.Question, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (q questionDo) FirstOrInit() (*sqlentity.Question, error) {
...
func (q questionDo) FirstOrCreate() (*sqlentity.Question, error) {
...
func (q questionDo) FindByPage(offset int, limit int) (result []*sqlentity.Question, count int64, err error) {
...
func (q questionDo) Delete(models ...*sqlentity.Question) (result gen.ResultInfo, err error) {
