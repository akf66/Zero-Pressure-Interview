...
func newStorage(db *gorm.DB, opts ...gen.DOOption) storage {
	...
	_storage.storageDo.UseModel(&sqlgen.Storage{})
...
type IStorageDo interface {
	...
	Unscoped() IStorageDo
	Create(values ...*sqlgen.Storage) error
	CreateInBatches(values []*sqlgen.Storage, batchSize int) error
	Save(values ...*sqlgen.Storage) error
	First() (*sqlgen.Storage, error)
	Take() (*sqlgen.Storage, error)
	Last() (*sqlgen.Storage, error)
	Find() ([]*sqlgen.Storage, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*sqlgen.Storage, err error)
	FindInBatches(result *[]*sqlgen.Storage, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*sqlgen.Storage) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*sqlgen.Storage, error)
	FirstOrCreate() (*sqlgen.Storage, error)
	FindByPage(offset int, limit int) (result []*sqlgen.Storage, count int64, err error)
...
func (s storageDo) Create(values ...*sqlgen.Storage) error {
	if len(values) == 0 {
		return nil
	}
...
func (s storageDo) CreateInBatches(values []*sqlgen.Storage, batchSize int) error {
	return s.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (s storageDo) Save(values ...*sqlgen.Storage) error {
	if len(values) == 0 {
		return nil
	}
...
func (s storageDo) First() (*sqlgen.Storage, error) {
	if result, err := s.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*sqlgen.Storage), nil
	}
}

func (s storageDo) Take() (*sqlgen.Storage, error) {
...
func (s storageDo) Last() (*sqlgen.Storage, error) {
...
func (s storageDo) Find() ([]*sqlgen.Storage, error) {
	result, err := s.DO.Find()
	return result.([]*sqlgen.Storage), err
}

func (s storageDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*sqlgen.Storage, err error) {
	buf := make([]*sqlgen.Storage, 0, batchSize)
...
func (s storageDo) FindInBatches(result *[]*sqlgen.Storage, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (s storageDo) FirstOrInit() (*sqlgen.Storage, error) {
...
func (s storageDo) FirstOrCreate() (*sqlgen.Storage, error) {
...
func (s storageDo) FindByPage(offset int, limit int) (result []*sqlgen.Storage, count int64, err error) {
...
func (s storageDo) Delete(models ...*sqlgen.Storage) (result gen.ResultInfo, err error) {
